...
export const D3Map = () => {
  ...
  if(worldGeoJSON !=null && csv !=null && manifest !=null && style !=null){
    ...
    //var layer4 =JSON.parse(JSON.stringify(manifest.layers[4])) as any
    //layer4.fill.values = style.fill.values
    
    //manifestCopy.layers[4] = layer4
    
  
    const projection = manifest.params.projection
    manifestCopy.params.projection = projections[projection]
    console.log("manifestCopy before merge")
    console.log(manifestCopy)
    console.log("before merge csv:  ", csv)
    ...
    console.log("manifestCopy after merge")
    console.log(manifestCopy)
